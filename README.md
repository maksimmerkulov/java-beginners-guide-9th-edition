...
- 📄 Упражнения из книги:
    ...
    - Стр. 263–265 — Доступ к членам и наследование
    - Стр. 265–267 — Конструкторы и наследование
    - Стр. 267–271 — Использование ключевого слова `super` для вызова конструкторов суперкласса
    - Стр. 271–274 — Использование ключевого слова `super` для доступа к членам суперкласса
    - Стр. 274–277 — Создание многоуровневой иерархии
    - Стр. 277–278 — Когда конструкторы выполняются?
    - Стр. 278–282 — Ссылки на суперклассы и объекты подклассов
